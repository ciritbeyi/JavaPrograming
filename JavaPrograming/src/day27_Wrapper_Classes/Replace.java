...
public class Replace {
    public static void main(String[] args) {
        ...
        String[] arr2 ={ "Ozgur", "Ali", "Yabanci", "Kenan", "Serife"};
       arr2 =  replace(arr2, 2, "Ediz");
        System.out.println(Arrays.toString(arr2));  // [Ozgur, Ali, Ediz, Kenan, Serife]
...
The method replaces the element of the array at given index with the new element, and returns the new array.
	Ex:	arr = {1,2,3,4,5};					replace(arr, 2, 30) ===> {1, 2, 30, 4, 5}

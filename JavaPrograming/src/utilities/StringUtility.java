...
// reverse the given string and returns a reversed string
...
// removes the duplicated characters from a given String, returns a String   //  "aaaabbbbcccc" => "abc"
    public static String removeDuplicate(String str){
        String result = "";
        for (int i = 0; i < str.length(); i++) {  // to acces the characters of str
